...
all: fetcher.o main.o pugixml.o xparser.o display.o sock.o cgi.o
	g++ ${CFLAGS} ${LDFLAGS} fetcher.o main.o pugixml.o sock.o xparser.o cgi.o display.o -o rssgen

clean:
	rm -f fetcher.o main.o pugixml.o xparser.o display.o sock.o cgi.o rssgen 
